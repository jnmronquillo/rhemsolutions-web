...
public class Mail {
	...
	public static boolean sendMessage(String mensaje,String subject, String correo,String fileFullName, String fileName){
        boolean rpta=false;
        ...
        try {
            ...
            t.connect("sistema@rhemsolutions.com","g@tit0x2");
